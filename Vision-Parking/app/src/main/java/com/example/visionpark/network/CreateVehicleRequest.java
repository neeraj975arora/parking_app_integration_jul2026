...
public class CreateVehicleRequest {
    ...
    public CreateVehicleRequest(String registrationNumber, String vehicleName, String vehicleType) {
    ...
    // Full constructor
    public CreateVehicleRequest(String registrationNumber, String vehicleName, String make, 
